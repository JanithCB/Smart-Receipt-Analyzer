...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Directory containing raw .txt knowledge documents",
    )
    parser.add_argument(
        "--output",
        type=Path,
    ...
    chunks = run_chunker(raw_docs_dir=args.docs_dir, chunks_path=args.output)
    print(f"Done. {len(chunks)} chunk(s) written to {args.output}")